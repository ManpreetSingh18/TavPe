...
>>>>>>> Stashed changes
        ...
        <div className="mb-4">
          <ul className="columns-2 md:columns-3 lg:columns-4 space-y-2">
            ...
            <li className="mr-4 mb-2">
              <span className="text-gray-700">Credit Card Apply Online</span>
            </li>
            <li className="mr-4 mb-2">
              <span className="text-gray-700">Credit Card Eligibility</span>
            </li>
            <li className="mr-4 mb-2">
              <span className="text-gray-700">Credit Card Bill Payment</span>
            </li>
            <li className="mr-4 mb-2">
              <span className="text-gray-700">HDFC Credit Card</span>
            </li>
            <li className="mr-4 mb-2">
            ...
            <li className="mr-4 mb-2">
              <span className="text-gray-700">Home Loan Interest Rates</span>
            </li>
            <li className="mr-4 mb-2">
              <span className="text-gray-700">HDFC Home Loan</span>
            </li>
            <li className="mr-4 mb-2">
              <span className="text-gray-700">ICICI Home Loan</span>
            </li>
            <li className="mr-4 mb-2">
              <span className="text-gray-700">
            ...
            <li className="mr-4 mb-2">
              <span className="text-gray-700">
                Best Cashback & Rewards Credit Cards in India
              </span>
            </li>
            <li className="mr-4 mb-2">
            ...
            <li className="mr-4 mb-2">
              <span className="text-gray-700">Health Insurance Plans</span>
            </li>
            <li className="mr-4 mb-2">
              <span className="text-gray-700">
        ...
        <div className="mb-4">
          <ul className="columns-2 md:columns-3 lg:columns-4 space-y-2">
            ...
            <li className="mr-4 mb-2">
              <span className="text-gray-700">Car Loan EMI Calculator</span>
            </li>
            <li className="mr-4 mb-2">
              <span className="text-gray-700">Car Loan Interest Rates</span>
            </li>
            <li className="mr-4 mb-2">
              <span className="text-gray-700">HDFC Car Loan</span>
            </li>
            <li className="mr-4 mb-2">
              <span className="text-gray-700">ICICI Car Loan</span>
            </li>
            <li className="mr-4 mb-2">
              <span className="text-gray-700">Business Loan</span>
            </li>
            <li className="mr-4 mb-2">
              <span className="text-gray-700">
            ...
            <li className="mr-4 mb-2">
              <span className="text-gray-700">HDFC Business Loan</span>
            </li>
            <li className="mr-4 mb-2">
              <span className="text-gray-700">
