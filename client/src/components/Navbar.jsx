            ...
            <ul className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6">
              ...
              <li className="relative">
                ...
                >
                  More Loans{" "}
                  <span
                    className={`caret ${isDropdownOpen ? "rotate-180" : ""}`}
                  >
                    &#9662;
                  </span>
                </button>
                <ul
                  className={`dropdown-menu absolute right-0 mt-2 bg-white shadow-md z-50 ${
              ...
              {isAdmin && (
                <li>
                  <NavLink
                    to="/admin/contacts"
                    className="bg-maroon text-maroon px-4 py-2 rounded-md transition duration-300 ease-in-out"
                  >
                    Admin
                  </NavLink>
                </li>
